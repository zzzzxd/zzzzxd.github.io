...
> 转载:https://segmentfault.com/a/1190000021199728
...
![traditional-hashing](traditional-hashing.png)
...
![ch-three-nodes-hash](ch-three-nodes-hash.png)
...
![ch-two-nodes-hash](ch-two-nodes-hash.png)
...
![ch-four-nodes-hash](ch-four-nodes-hash.png)
...
![hash-ring-hash-servers](/hash-ring-hash-servers.png)
...
![hash-ring-objects-servers](hash-ring-objects-servers.png)

#### 3.4 服务器增加的情况

假设由于业务需要，我们需要增加一台服务器 cs4，经过同样的 hash 运算，该服务器最终落于 t1 和 t2 服务器之间，具体如下图所示：

![hash-ring-add-server](http://cdn.semlinker.com/hash-ring-add-server.jpg)
...
![hash-ring-remove-server](hash-ring-remove-server.png)
...
![ch-virtual-nodes](ch-virtual-nodes.png)
